...
l6854:	
;main.c: 40: ADC_STUDY_VALUE = Read_EEPROM_u16(0x00);
	movlw	(0)
...
l6856:	
;main.c: 41: LED_Study_End();
	fcall	_LED_Study_End
	line	44
	
l6858:	
;main.c: 44: ExchChannel(1);
	movlw	(01h)
	fcall	_ExchChannel
	line	45
	
l6860:	
;main.c: 45: for(i=0;i<5;i++)
	clrf	(_i)
	line	46
	
l6866:	
;main.c: 46: ADC1_ADCOUT = GetADCValue();
	fcall	_GetADCValue
...
l6872:	
;main.c: 47: ExchChannel(5);
	movlw	(05h)
	fcall	_ExchChannel
	line	48
	
l6874:	
;main.c: 48: for(j=0;j<5;j++)
	clrf	(_j)
	line	49
	
l6880:	
;main.c: 49: ADC6_INPUT = GetADCValue();
	fcall	_GetADCValue
	movf	(1+(?_GetADCValue)),w
	movwf	(_ADC6_INPUT+1)
	movf	(0+(?_GetADCValue)),w
...
l6886:	
;main.c: 50: Delay_xms(5);
	movlw	05h
	movwf	(?_Delay_xms)
	clrf	(?_Delay_xms+1)
	fcall	_Delay_xms
	line	52
;main.c: 52: if(isKeyPressed())
	fcall	_isKeyPressed
	xorlw	0
	skipnz
	goto	u231
...
l6890:	
;main.c: 58: ADC_STUDY_VALUE = ADC1_ADCOUT;
...
l6892:	
;main.c: 59: Write_EEPROM_u16(0x00,ADC_STUDY_VALUE);
...
l6900:	
;main.c: 66: if(ADC1_ADCOUT <= ADC_STUDY_VALUE){
	movf	(_ADC1_ADCOUT+1),w
...
l6716:	
;myadc.c: 31: CHS0=1;CHS1=0;CHS2=1;
	bsf	(250/8),(250)&7
